...
data class SpriteModelResponse(@SerializedName(value = "back_default") var back_default: String,
                               ...
                               @SerializedName(value = "other") var other: OtherModelResponse,
                               @SerializedName(value = "versions") var versions: VersionNumbersModelResponse
)
