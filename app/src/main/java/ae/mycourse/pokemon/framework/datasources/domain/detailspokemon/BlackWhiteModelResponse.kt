...
data class BlackWhiteModelResponse(@SerializedName(value = "animated") var animated: AnimatedModelResponse,
                                   @SerializedName(value = "back_default") var back_default: String,
