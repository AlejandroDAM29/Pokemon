...
data class SpriteModel(@SerializedName(value = "back_default") var back_default: String,
                       ...
                       @SerializedName(value = "other") var other: OtherModel,
                       @SerializedName(value = "versions") var versions: VersionNumbersModel
)
